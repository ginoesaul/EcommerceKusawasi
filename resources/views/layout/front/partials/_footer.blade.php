   ...
   <div class="footer-content-col">
      <div class="container">
         <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
               <div class="mobile-collapse">
                  <h4 class="mobile-collapse_title visible-xs">COMPRAS SEGURAS</h4>
                  <div class="mobile-collapse_content">
                     <a href="#" class="services-block">
            ...
            <div class="col-sm-6 col-md-3">
               <div class="mobile-collapse">
                  <h4 class="mobile-collapse_title visible-xs">APOYO</h4>
                  <div class="mobile-collapse_content">
                     <a href="#" class="services-block">
                        <span class="icon icon-headset_mic"></span>
                        <div class="title">Apoyo</div>
                        <p>Apoyo efectivo y amigable</p>
                     </a>
                  </div>
               </div>
            </div>
   ...
   <div class="copyright">
      <div class="container text-center">
         <div class="box-copyright">
            <a href="#">@Copyright 2020. <span>By Team Kusawasi.</span></a>
         </div>
      </div>
   </div>
